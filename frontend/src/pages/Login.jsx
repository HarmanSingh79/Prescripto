...
const Login = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='min-h-[80vh] items-center flex'>
      <div className='flex flex-col m-auto gap-3 items-start p-8 min-w-85 sm:min-w-96 border rounded-xl text-zinc-600 shadow-lg'>
