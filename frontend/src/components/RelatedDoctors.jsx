        ...
        <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
            ...
            <div className='grid grid-cols-auto w-full gap-4 pt-5 gap-y-6 px-3 sm:px-0'>
                {relDoc.slice(0, 3).map((item, index) => (
                    <div onClick={() => { navigate(`/appointment/${item._id}`); scrollTo(0, 0) }} key={index} className='border border-blue-200 rounded-xl overflow-hidden cursor-pointer hover:translate-y-2.5 transition-all duration-400'>
                        <img className='bg-blue-50 w-full aspect-square object-fit' src={item.image} alt="" />
                        <div className='p-4'>
