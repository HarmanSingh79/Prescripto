    ...
    <div className='m-5 max-sm:m-3'>
      <div className='flex flex-wrap max-sm:gap-2 gap-3 max-sm:justify-center'>
        ...
        <div className='max-sm:min-w-[70vw] flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
          <img className='w-14 max-sm:w-10' src={assets.earning_icon} alt="" />
          <div>
            <p className='text-xl font-semibold text-gray-600 max-sm:text-sm'>{currency}{dashData.earnings}</p>
            <p className='text-gray-400 max-sm:text-[15px]'>Earnings</p>
          </div>
        </div>
        ...
        <div className='max-sm:min-w-[70vw] flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
          ...
          <div>
            <p className='text-xl max-sm:text-sm font-semibold text-gray-600'>{dashData.appointments}</p>
        ...
        <div className='pt-4 border border-t-0 border-gray-200'>
          {
            dashData.latestAppointments.map((item, index) => (
              <div key={index} className='flex items-center px-6 py-3 gap-3 hover:bg-gray-100'>
                <img className='rounded-full w-10 h-10 object-fit' src={item.userData.image} alt="" />
